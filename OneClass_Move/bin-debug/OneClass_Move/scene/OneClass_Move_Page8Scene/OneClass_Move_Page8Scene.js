...
var OneClass_Move_Page8Scene = (function (_super) {
    __extends(OneClass_Move_Page8Scene, _super);
    function OneClass_Move_Page8Scene() {
        var _this = _super.call(this) || this;
        _this.skinName = "OneClass_Move_Page8Scene_Skin";
        return _this;
    }
    /** 每次进入 */
    OneClass_Move_Page8Scene.prototype.onAdd = function () {
    ...
    //     }
    // }
    OneClass_Move_Page8Scene.prototype.execMessage = function (data) {
        _super.prototype.execMessage.call(this, data);
        // this.showCom.execMessage(data);
    };
    /** 这里进行移出场景的处理 **/
    OneClass_Move_Page8Scene.prototype.onDestroy = function () {
        _super.prototype.onDestroy.call(this);
        // this.showCom.onDestroy();
    };
    OneClass_Move_Page8Scene.key = "OneClass_Move_Page8Scene";
    return OneClass_Move_Page8Scene;
}(DragAnyMakeRuleListCommonScene));
__reflect(OneClass_Move_Page8Scene.prototype, "OneClass_Move_Page8Scene");
//# sourceMappingURL=OneClass_Move_Page8Scene.js.map
...
var OneClass_Move_Page3Scene = (function (_super) {
    __extends(OneClass_Move_Page3Scene, _super);
    function OneClass_Move_Page3Scene() {
        var _this = _super.call(this) || this;
        _this.skinName = "OneClass_Move_Page3Scene_Skin";
        return _this;
    }
    /** 每次进入 */
    OneClass_Move_Page3Scene.prototype.onAdd = function () {
    ...
    OneClass_Move_Page3Scene.prototype.isCanSetToRect = function (indexForImgList, indexRect, obj, isNewItem) {
        return this.isCanSetToRectForReal(indexForImgList, indexRect, obj, isNewItem);
    };
    OneClass_Move_Page3Scene.prototype.isCanSetToRectForReal = function (indexForImgList, indexRect, obj, isNewItem) {
        // return true;
        return this.isCanSetToRectForRectMax(indexRect, obj, 1);
    };
    OneClass_Move_Page3Scene.prototype.refreshForListTouchEnd = function () {
    ...
    OneClass_Move_Page3Scene.prototype.execMessage = function (data) {
        _super.prototype.execMessage.call(this, data);
        this.showCom.execMessage(data);
    };
    /** 这里进行移出场景的处理 **/
    OneClass_Move_Page3Scene.prototype.onDestroy = function () {
        _super.prototype.onDestroy.call(this);
        this.showCom.onDestroy();
    };
    OneClass_Move_Page3Scene.key = "OneClass_Move_Page3Scene";
    return OneClass_Move_Page3Scene;
}(DragAnyMakeRuleListCommonScene));
__reflect(OneClass_Move_Page3Scene.prototype, "OneClass_Move_Page3Scene");
//# sourceMappingURL=OneClass_Move_Page3Scene.js.map
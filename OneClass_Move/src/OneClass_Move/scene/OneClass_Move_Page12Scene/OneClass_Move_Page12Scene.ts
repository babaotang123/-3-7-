class OneClass_Move_Page12Scene extends DragAnyMakeRuleListCommonScene {

    static key:string = "OneClass_Move_Page12Scene";

    public constructor() {
        super();
        this.skinName = "OneClass_Move_Page12Scene_Skin";
    }

class OneClass_Move_Page7Scene extends DragAnyMakeRuleListCommonScene {

    static key:string = "OneClass_Move_Page7Scene";

    public constructor() {
        super();
        this.skinName = "OneClass_Move_Page7Scene_Skin";
    }

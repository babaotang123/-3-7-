class OneClass_Move_Page2Scene extends DragAnyMakeRuleListCommonScene {

    static key:string = "OneClass_Move_Page2Scene";

    public constructor() {
        super();
        this.skinName = "OneClass_Move_Page2Scene_Skin";
    }

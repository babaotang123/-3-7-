class OneClass_Move_Page11Scene extends DragAnyMakeRuleListCommonScene {

    static key:string = "OneClass_Move_Page11Scene";

    public constructor() {
        super();
        this.skinName = "OneClass_Move_Page11Scene_Skin";
    }

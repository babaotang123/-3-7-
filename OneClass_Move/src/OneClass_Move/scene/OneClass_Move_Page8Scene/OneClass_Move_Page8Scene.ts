class OneClass_Move_Page8Scene extends DragAnyMakeRuleListCommonScene {

    static key:string = "OneClass_Move_Page8Scene";

    public constructor() {
        super();
        this.skinName = "OneClass_Move_Page8Scene_Skin";
    }

class OneClass_Move_Page4Scene extends DragAnyMakeRuleListCommonScene {

    static key:string = "OneClass_Move_Page4Scene";

    public constructor() {
        super();
        this.skinName = "OneClass_Move_Page4Scene_Skin";
    }

class OneClass_Move_Page5Scene extends DragAnyMakeRuleListCommonScene {

    static key:string = "OneClass_Move_Page5Scene";

    public constructor() {
        super();
        this.skinName = "OneClass_Move_Page5Scene_Skin";
    }

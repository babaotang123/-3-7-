class OneClass_Move_Page3Scene extends DragAnyMakeRuleListCommonScene {

    static key:string = "OneClass_Move_Page3Scene";

    public constructor() {
        super();
        this.skinName = "OneClass_Move_Page3Scene_Skin";
    }

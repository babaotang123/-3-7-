...
})(eui.Skin);generateEUI.paths['resource/OneClass_Move/game_skins/OneClass_Move_Page14Scene/OneClass_Move_Page14Scene_Skin.exml'] = window.OneClass_Move_Page14Scene_Skin = (function (_super) {
	__extends(OneClass_Move_Page14Scene_Skin, _super);
	function OneClass_Move_Page14Scene_Skin() {
		_super.call(this);
		this.skinParts = ["img_bg","btn_reset","img_0","img_1","r_1","group"];
		
		this.height = 1348;
		this.width = 1562;
		this.elementsContent = [this.group_i()];
	}
	var _proto = OneClass_Move_Page14Scene_Skin.prototype;

	_proto.group_i = function () {
		var t = new eui.Group();
		this.group = t;
		t.elementsContent = [this.img_bg_i(),this.btn_reset_i(),this.img_0_i(),this.img_1_i(),this.r_1_i()];
		return t;
	};
	_proto.img_bg_i = function () {
		var t = new eui.Image();
	...
	_proto.btn_reset_i = function () {
		var t = new eui.Image();
		this.btn_reset = t;
		t.source = "main_preload_json.main_btn_puase_png";
		t.x = 1483;
		t.y = 1274.5;
		return t;
	};
	...
	_proto.r_1_i = function () {
		...
		this.r_1 = t;
		t.alpha = 0;
		t.anchorOffsetX = 621.39;
		t.anchorOffsetY = 192.24;
		t.height = 394;
		t.width = 1252;
		t.x = 777.39;
		t.y = 538.24;
	...
	return OneClass_Move_Page14Scene_Skin;
})(eui.Skin);generateEUI.paths['resource/OneClass_Move/game_skins/OneClass_Move_Page15Scene/OneClass_Move_Page15Scene_Skin.exml'] = window.OneClass_Move_Page15Scene_Skin = (function (_super) {
	__extends(OneClass_Move_Page15Scene_Skin, _super);
	function OneClass_Move_Page15Scene_Skin() {
		_super.call(this);
		this.skinParts = ["img_bg","group"];
	...
	var _proto = OneClass_Move_Page15Scene_Skin.prototype;
	...
	return OneClass_Move_Page15Scene_Skin;
	...
	_proto.group_i = function () {
		var t = new eui.Group();
		this.group = t;
		t.elementsContent = [this.img_bg_i(),this._Label1_i()];
		return t;
	};
	_proto.img_bg_i = function () {
		var t = new eui.Image();
